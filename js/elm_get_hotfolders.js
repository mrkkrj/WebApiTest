...
var _user$project$Main$Hotfolder = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, active: b, name: c, hfType: d, input: e, output: f, hfStatus: g};
	});
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {serverUrl: a, hotfolders: b, status: c, statusTxt: d};
	});
...
var _user$project$Main$InvalidHotf = {ctor: 'InvalidHotf'};
var _user$project$Main$XmlHotf = {ctor: 'XmlHotf'};
var _user$project$Main$ImgHotf = {ctor: 'ImgHotf'};
var _user$project$Main$PdfHotf = {ctor: 'PdfHotf'};
var _user$project$Main$hotfListRow = function (hotfolder) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						hotfolder.active ? 'enabled' : 'disabled')
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(hotfolder.name)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_elm_lang$core$Native_Utils.eq(hotfolder.hfType, _user$project$Main$PdfHotf) ? 'PDF' : (_elm_lang$core$Native_Utils.eq(hotfolder.hfType, _user$project$Main$ImgHotf) ? 'Image' : (_elm_lang$core$Native_Utils.eq(hotfolder.hfType, _user$project$Main$XmlHotf) ? 'XML' : '???')))
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_elm_lang$core$String$join, ', ', hotfolder.input))
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_elm_lang$core$String$join, ', ', hotfolder.output))
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(hotfolder.hfStatus)
					]))
			]));
};
var _user$project$Main$hotfolderList = function (hotfolders) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[]),
						A2(_elm_lang$core$List$map, _user$project$Main$hotfListRow, hotfolders))
					]))
			]));
};
var _user$project$Main$hotfTypeFromFileExt = function (fname) {
	return A2(_elm_lang$core$String$endsWith, '.imghf', fname) ? _user$project$Main$ImgHotf : _user$project$Main$PdfHotf;
};
var _user$project$Main$hotfTypeFromHref = function (href) {
	return A2(_elm_lang$core$String$startsWith, 'resources/workflows/image/', href) ? _user$project$Main$ImgHotf : (A2(_elm_lang$core$String$startsWith, 'resources/workflows/pdf/', href) ? _user$project$Main$PdfHotf : (A2(_elm_lang$core$String$startsWith, 'resources/workflows/jt/', href) ? _user$project$Main$XmlHotf : _user$project$Main$InvalidHotf));
};
var _user$project$Main$decodeHotfolder = A2(
			...
			A2(
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
							_elm_lang$core$Json_Decode$succeed(_user$project$Main$Hotfolder),
							A2(_elm_lang$core$Json_Decode_ops[':='], 'href', _elm_lang$core$Json_Decode$string)),
						A2(
				...
				A2(
					_elm_lang$core$Json_Decode_ops[':='],
					'href',
					A2(_elm_lang$core$Json_Decode$object1, _user$project$Main$hotfTypeFromHref, _elm_lang$core$Json_Decode$string))),
			A2(
				_elm_lang$core$Json_Decode_ops[':='],
				'parameters',
				A2(
	...
	A2(
		...
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				['validationState']),
			_elm_lang$core$Json_Decode$string)));
var _user$project$Main$hotfolderListDecoder = _elm_lang$core$Json_Decode$list(_user$project$Main$decodeHotfolder);
var _user$project$Main$NewTime = function (a) {
	return {ctor: 'NewTime', _0: a};
};
var _user$project$Main$getTime = A3(
	_elm_lang$core$Task$perform,
	function (x) {
		return _user$project$Main$NewTime(0.0);
	},
	_user$project$Main$NewTime,
	_elm_lang$core$Time$now);
var _user$project$Main$GetTimeThenFetchAllHfs = {ctor: 'GetTimeThenFetchAllHfs'};
var _user$project$Main$view = function (model) {
	var hotfCount = _elm_lang$core$List$length(model.hotfolders);
	var hotfListVisible = _elm_lang$core$Native_Utils.eq(model.status, false) ? 'hidden' : 'visible';
	var errorLabel = _elm_lang$core$Native_Utils.eq(model.status, false) ? 'Cannot fetch data from Server: ' : '';
	var msgVisible = _elm_lang$core$Native_Utils.eq(model.statusTxt, '') ? 'hidden' : 'visible';
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Hotfolder Monitor Tool')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html_Attributes$src('image/logo.png')
															]),
														_elm_lang$core$Native_List.fromArray(
															[]))
													])),
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text(model.serverUrl)
															]))
													])),
												A2(
												_elm_lang$html$Html$td,
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html_Attributes$class('tftextbtn-full'),
																_elm_lang$html$Html_Events$onClick(_user$project$Main$GetTimeThenFetchAllHfs)
															]),
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('Fetch HF List')
															]))
													]))
											]))
									]))
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'visibility', _1: msgVisible}
							])),
						_elm_lang$html$Html_Attributes$class('error-text')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], errorLabel, model.statusTxt))
					])),
				A2(
				_elm_lang$html$Html$h3,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'visibility', _1: hotfListVisible}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(hotfCount),
								')')))
					])),
				A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Main$hotfolderList(model.hotfolders)
					]))
			]));
};
var _user$project$Main$FetchAllFail = function (a) {
	return {ctor: 'FetchAllFail', _0: a};
};
var _user$project$Main$FetchAllDone = function (a) {
	return {ctor: 'FetchAllDone', _0: a};
};
var _user$project$Main$getHotfolderList = F2(
	function (serverUrl, timestamp) {
		var cachebuster = _elm_lang$core$Basics$toString(timestamp);
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			'http://',
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'/resources/workflows?style=detailed',
					A2(_elm_lang$core$Basics_ops['++'], '&_=', cachebuster))));
		return A3(
			_elm_lang$core$Task$perform,
			_user$project$Main$FetchAllFail,
			_user$project$Main$FetchAllDone,
			A2(_evancz$elm_http$Http$get, _user$project$Main$hotfolderListDecoder, url));
	});
			...
			case 'FetchAllHfs':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							status: true,
							statusTxt: 'Initiating data fetch...',
							hotfolders: _elm_lang$core$Native_List.fromArray(
								[])
						}),
					_1: A2(_user$project$Main$getHotfolderList, model.serverUrl, 0.0)
				};
			case 'FetchAllDone':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{status: true, statusTxt: '', hotfolders: _p0._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FetchAllFail':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							status: false,
							statusTxt: _elm_lang$core$Basics$toString(_p0._0),
							hotfolders: _elm_lang$core$Native_List.fromArray(
								[])
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'GetTimeThenFetchAllHfs':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$getTime};
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
					...
					_1: A2(_user$project$Main$getHotfolderList, model.serverUrl, _p0._0)
				};
		}
	});
...
var _user$project$Main$FetchAllHfs = {ctor: 'FetchAllHfs'};
